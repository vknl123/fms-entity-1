...
public class Substation implements SubstationInterface {
	...
	public String toString() {
		return "SubStation{" + "id=" + id + ", substationName='" + substationName + '\'' + ", substationCode='"
				+ substationCode + '\'' + ", powerTransformer=" + powerTransformer + ", incomingLines=" + incomingLines
				+ ", zoneId=" + zoneId + ", createdBy='" + createdBy + '\'' + ", createdOn=" + createdOn
